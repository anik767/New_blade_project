        ...
        <div class="bg-white/10 backdrop-blur-lg rounded-lg shadow-2xl p-8 border border-white/20">
            ...
            <div class="space-y-4">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" 
                            class="group relative w-full flex justify-center py-3 px-4 border border-gray-600 text-sm font-medium rounded-lg text-gray-300 bg-gray-800/50 hover:bg-gray-700/50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-all duration-200 transform ">
                        <span class="absolute left-0 inset-y-0 flex items-center pl-3">

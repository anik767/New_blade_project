                        ...
                        <div class="mb-4">
                            @if($banner && $banner->background_media)
                                ...
                                <div class="bg-gray-100 rounded-xl overflow-hidden">
                                    <div class="relative h-32 bg-gray-200">
                                        @if($isVideo)
                                            <video class="w-full h-full object-cover" muted loop playsinline>
                                                <source src="{{ asset('storage/' . $banner->background_media) }}" type="video/{{ $ext }}">
                                    ...
                                    <div class="p-3">
                                        <div class="flex items-center">
                                            <span class="text-sm font-medium text-gray-700 truncate">{{ basename($banner->background_media) }}</span>
                                        </div>
                                    </div>
                                </div>
                            @else

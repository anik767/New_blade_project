...
@section('content')
    <div class="p-6">
        ...
        <x-forms.admin-form :action="route('admin.projects.update', $project->id)" title="Project Information" submit-text="Update Project" method="PUT"
            ...
            <div class="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-6 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <x-forms.form-field label="Project Title" name="title" required placeholder="E-commerce Website"
                        :value="$project->title" />

                    <x-forms.form-field label="GitHub Repository" name="github_link" type="url"
                        placeholder="https://github.com/username/repo"
                        help="Optional: Link to the project's GitHub repository" :value="$project->github_link" />
                </div>

                <x-forms.form-field label="Project Description" name="description" type="textarea" required
            ...
            <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 mb-8">
                ...
                <div>
                    ...
                    @if ($project->image)
                        ...
                        <div
                            class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 p-4 bg-gray-50 border border-gray-200 rounded-lg">

                            <div class="w-full ">
                                <p class="text-md font-medium text-green-700 mb-3 text-center">Current Project Image:</p>
                                <img src="{{ asset('storage/' . $project->image) }}" alt="Current project image"
                                    class="max-w-full  mx-auto object-cover rounded-lg border border-gray-200 shadow-sm group-hover:shadow-md transition-shadow duration-200">
                            </div>
                            <div id="project-image-preview-wrapper" class="mt-4 hidden">
                                <p class="text-md font-medium text-red-700 mb-2 text-center">Selected Image:</p>
                                <img id="project-image-preview" alt="Selected image preview"
                                    class="max-w-full mx-auto  rounded-lg border border-gray-200 shadow-sm " />
                            </div>
                        </div>
                    @endif

                    <div class="relative">
                        <input type="file" name="image" id="project-image-input"
                    ...
                    <div class="bg-white p-4 rounded-lg border border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-lg font-semibold text-gray-900">{{ $project->created_at->format('M d, Y') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-4 rounded-lg border border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-lg font-semibold text-gray-900">{{ $project->updated_at->format('M d, Y') }}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-lg font-semibold text-gray-900">
                                    {{ $project->github_link ? 'Linked' : 'Not Set' }}</p>
                            </div>
                        </div>
                    </div>
                </div>

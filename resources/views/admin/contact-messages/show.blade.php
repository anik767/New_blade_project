                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1">
                                ...
                                <select id="status-select" class="mt-1 w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200">
                        ...
                        <div class="pt-4 border-t border-gray-200">
                            <div class="grid grid-cols-2 gap-4">
                                <div class="text-center p-3 bg-blue-50 rounded-lg">
                                    <div class="text-2xl font-bold text-blue-600">{{ strlen($contactMessage->message) }}</div>
                                    <div class="text-xs text-blue-600 font-medium">Characters</div>
                                </div>
                                <div class="text-center p-3 bg-green-50 rounded-lg">
                                    <div class="text-2xl font-bold text-green-600">{{ str_word_count($contactMessage->message) }}</div>

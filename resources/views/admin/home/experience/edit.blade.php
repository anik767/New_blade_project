...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-3 sm:p-4 md:p-6">
            ...
            <div class="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-6">
                <div class="flex-1">
                    <div class="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-2 mb-4 sm:mb-6">
                        <div class="p-3 sm:p-4 bg-gradient-to-r from-purple-500 to-pink-600 rounded-xl sm:rounded-2xl mr-4 sm:mr-6 shadow-lg self-start">
                            <svg class="w-8 h-8 sm:w-10 sm:h-10 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V6a2 2 0 012 2v6a2 2 0 01-2 2H8a2 2 0 01-2-2V8a2 2 0 012-2h8z"></path>
                            </svg>
                        </div>
                        <div>
                            <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-2">Home Experience</h1>
                            <p class="text-gray-600 text-base sm:text-lg">Manage your work experience for the homepage</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4">
                        @if($banner->exists)
                            <div class="flex items-center bg-green-50 px-3 sm:px-4 md:px-5 py-2 sm:py-3 rounded-xl border border-green-200">
                                ...
                                <span class="text-gray-700 font-medium text-sm sm:text-base">Last updated: {{ $banner->updated_at->diffForHumans() }}</span>
                            </div>
                        @else
                            <div class="flex items-center bg-blue-50 px-3 sm:px-4 md:px-5 py-2 sm:py-3 rounded-xl border border-blue-200">
                                <svg class="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                <span class="text-blue-700 font-medium text-sm sm:text-base">New experience section - will be created when saved</span>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="text-center p-4 sm:p-6 bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 min-w-[100px] sm:min-w-[120px]">
                    <div class="text-3xl sm:text-4xl font-bold text-purple-600 mb-2">{{ count($banner->experience ?? []) }}</div>
                    <div class="text-xs sm:text-sm text-gray-600 font-medium">Experiences</div>
                </div>
            </div>
        </div>
        ...
        >
            <!-- Experience Content -->
            <div class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 border border-purple-200 shadow-lg">
                <h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6 flex items-center">
                    <div class="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-purple-500 to-pink-600 rounded-xl sm:rounded-2xl flex items-center justify-center mr-3 sm:mr-4 shadow-lg">
                        <svg class="w-5 h-5 sm:w-6 sm:h-6 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V6a2 2 0 012 2v6a2 2 0 01-2 2H8a2 2 0 01-2-2V8a2 2 0 012-2h8z"></path>
                        </svg>
                    </div>
                    Work Experience

<footer class="bg-card text-text border-t border-card shadow-card">
            ...
            <div class="lg:col-span-2">
                ...
                <form id="contact-form" class="space-y-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" id="name" name="name" required
                                   class="w-full px-3 py-2 bg-background border border-card rounded-[12px] text-text placeholder-muted focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent/20 transition-all duration-300 text-sm shadow-input focus:shadow-input-focus"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div>
                            <button type="submit" 
                                    class="w-full bg-accent text-background font-medium py-2 px-4 rounded-[12px] text-sm hover:bg-accent/90 transition-all duration-300 focus-ring mt-6 shadow-btn hover:shadow-btn-hover">
                                Send Message
                            </button>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="message" name="message" rows="2" required
                                  class="w-full px-3 py-2 bg-background border border-card rounded-[12px] text-text placeholder-muted focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent/20 transition-all duration-300 resize-none text-sm shadow-input focus:shadow-input-focus"
                ...
                <div id="form-message" class="mt-3 hidden">
                    <div id="success-message" class="bg-green-100 border border-green-300 text-green-700 px-3 py-2 rounded text-sm hidden"></div>
                    <div id="error-message" class="bg-red-100 border border-red-300 text-red-700 px-3 py-2 rounded text-sm hidden"></div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="flex space-x-2">
                        <a href="#" class="p-2 bg-muted/10 border border-card rounded-lg text-muted hover:text-accent hover:border-accent transition-all duration-300">

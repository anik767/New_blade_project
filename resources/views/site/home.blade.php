...
<div class="bg-background text-text min-h-screen">
    ...
    <section class="relative h-screen bg-cover bg-center bg-no-repeat"
        ...
        <div class="absolute inset-0 bg-white bg-opacity-0"></div>

        <div
            class="container mx-auto h-full grid grid-cols-1 md:grid-cols-2 items-center px-6 relative font-rajdhani z-10 text-[#c4cfde]">
            <div
                ...
                <div class="flex justify-center md:justify-start">
                    @if (optional($banner)->cv_file)
                        <a href="{{ asset('storage/' . $banner->cv_file) }}" download
                            class="inline-block px-8 py-3 border-2 border-accent rounded-lg font-semibold tracking-wide text-accent hover:bg-acttive hover:text-dark transition duration-300 shadow-lg">
                            Download CV
                        </a>
                    @else
                        <span
                            class="inline-block px-8 py-3 border-2 border-muted rounded-lg font-semibold tracking-wide text-muted cursor-not-allowed">
                            CV Not Available
                        </span>
                    @endif
                </div>
    ...
    <section class="py-24 font-sans">
        <div class="container mx-auto px-6 ">
            <header class="text-center mb-20">
                <h2 class="text-5xl font-extrabold tracking-wide mb-4 text-text">Get to Know Me</h2>
                <p class="text-lg text-muted font-medium max-w-2xl mx-auto">Let me introduce myself</p>
            </header>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                <div class="space-y-8">
                    ...
                    <p class="text-lg leading-relaxed text-muted max-w-lg mx-auto md:mx-0">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                    ...
                    @foreach ($highlights as $item)
                        <div
                            class="bg-gradient-to-tl from-[#23272b] via-[#e2e2e2]/5  to-[#1e2024] rounded-2xl p-8 border border-gray-700 shadow-lg shadow-accent/30  hover:shadow-acttive/30  transition duration-300 text-center">
    ...
    <section class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 px-4 container mx-auto py-10">
        <article
            class="group relative bg-gradient-to-tl from-[#23272b] via-[#e2e2e2]/30  to-[#1e2024] rounded-xl overflow-hidden border border-gray-700 shadow-lg shadow-accent/30 transition duration-300 hover:bg-[#353940]  ">
            ...
            <div
                class="relative z-10 bg-card px-6 pt-4 pb-6 rounded-b-xl group-hover:bg-transparent transition-colors">
                <span class="uppercase text-xs tracking-wider font-medium text-muted">Recipe</span>
                <h3 class="mt-1 mb-2 font-serif text-lg font-semibold text-text">Crisp Spanish tortilla Matzo brei</h3>
    ...
    <section class="py-20" id="projects">
        <div class="container mx-auto px-6 ">
            <h2 class="text-5xl font-extrabold text-center text-text mb-16">Projects</h2>
            ...
            @else
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
                    @foreach ($projects as $project)
                        <a href="{{ route('projects.show', $project->slug) }}"
                            class="block rounded-3xl overflow-hidden border border-gray-700 shadow-lg shadow-accent/30  hover:shadow-acttive/50 transition-shadow duration-300 cursor-pointer bg-gradient-to-tl from-[#23272b] via-[#e2e2e2]/10  to-[#1e2024]">
                            @if ($project->image)
                            ...
                            @endif
                            <div class="p-6">
                                <h3 class="text-2xl font-semibold mb-3 text-text two-line-ellipsis capitalize"
                                    title="{{ $project->title }}">
                                    {{ $project->title }}
                                </h3>

                                <p class="text-muted mb-5">{{ Str::limit($project->description, 120) }}</p>

                                @if ($project->github_link)
                                    <span class="text-acttive font-semibold hover:underline cursor-pointer">View Project
                                        →</span>
                                @else
                ...
                <div class="mt-12 text-center">
                    <a href="{{ route('projects.index') }}"
                        class="inline-block px-8 py-3 border-2 border-accent rounded-lg font-semibold tracking-wide text-accent hover:bg-acttive hover:border-acttive hover:text-dark transition duration-300 shadow-lg">
                        View More Projects
                    </a>
                </div>
            @endif
    ...
    <section class="py-20" id="blog">
        <div class="container mx-auto px-6">
            <h2 class="text-5xl font-extrabold text-text text-center mb-16">Latest Blogs</h2>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
                    @foreach ($posts as $post)
                        <a href="{{ route('site.blog.show', $post->slug) }}"
                            class=" bg-gradient-to-tl from-[#23272b] via-[#e2e2e2]/10  to-[#1e2024] rounded-3xl p-8 cursor-pointer flex flex-col border border-gray-700 shadow-lg shadow-accent/30  hover:shadow-acttive/50 transition duration-300 no-underline">
                            ...
                            <h3 class="text-2xl font-semibold mb-3 text-text">
                                {{ $post->title }}
                            </h3>
                            ...
                            <span class="mt-auto font-semibold text-acttive text-lg hover:underline">
                                Read More →
                            </span>
                        </a>
                    @endforeach
    ...
    <section class="py-20" id="case-studies">
        <div class="container mx-auto px-6 ">
            <h2 class="text-5xl font-extrabold text-text text-center mb-16">Case Studies</h2>
            <div class="space-y-12">
                <div
                    class="bg-gradient-to-l from-[#23272b] via-[#e2e2e2]/10  to-[#1e2024] p-8 rounded-3xl border border-gray-700 shadow-lg shadow-accent/30  transition duration-300 hover:shadow-acttive/50">
                    <h3 class="text-3xl font-semibold mb-4 text-text">Speed Optimization for a Laravel App</h3>
                    <p class="text-muted text-lg mb-4">Reduced load time from 4s to under 1s by implementing caching,
    ...
    <section class="container mx-auto px-6 py-20">
        <div class="grid md:grid-cols-2 gap-16 items-start">
            ...
            <div>
                <h2 class="text-5xl font-extrabold mb-6 text-text">Design</h2>
                <p class="text-muted mb-8 leading-relaxed text-lg max-w-lg">
                    Immersed in the vibrant world of creativity, I specialize in designing visually striking and
                    user-centric digital experiences.
                </p>

                <ul class="space-y-5 list-disc list-inside text-muted font-semibold text-xl max-w-md">
            ...
            <div>
                <h2 class="text-5xl font-extrabold mb-6 text-text">Develop</h2>
                <p class="text-muted mb-8 leading-relaxed text-lg max-w-lg">

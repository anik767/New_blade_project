    ...
    <div class="container mx-auto px-6 py-16">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-8">
                <h1 class="text-4xl font-bold text-text mb-4">Project with Title, Image and Meta Info</h1>
            </div>
            ...
            <div class="mt-12 pt-8 border-t border-gray-700">
                <h3 class="text-2xl font-bold text-text mb-6">Comments ({{ $project->comments->count() }})</h3>
                    ...
                    @foreach($recentProjects as $recentProject)
                        <div class="bg-card border border-gray-700 rounded-lg overflow-hidden shadow-lg shadow-accent/30 hover:shadow-acttive/50 transition-shadow">
                            ...
                            <div class="p-4">
                                ...
                                <a href="{{ route('projects.show', $recentProject->slug) }}" class="text-accent hover:text-acttive text-sm font-medium">
                                    READ MORE »
                                </a>

    ...
    <div class="container mx-auto px-6 py-16">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-8">
                <h1 class="text-4xl font-bold text-black mb-4">Project with Title, Image and Meta Info</h1>
            </div>
            ...
            <div class="text-center mb-6">
                ...
                <p class="text-muted text-sm mb-4">Published in Projects, Portfolio</p>
            ...
            <div class="mt-12 pt-8 border-t border-gray-700">
                <h3 class="text-2xl font-bold text-black mb-6">Comments ({{ $project->comments->count() }})</h3>
            ...
            <div class="mt-12 pt-8 border-t border-gray-700">
                <div class="flex items-center mb-4">
                    <span class="text-muted font-medium mr-4">Share Project:</span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    @foreach($recentProjects as $recentProject)
                        <div class="bg-card border border-gray-700 rounded-lg overflow-hidden shadow-lg shadow-accent/30 hover:shadow-acttive/50 transition-shadow">
                            ...
                            @endif
                            <div class="p-4">
                                <h4 class="font-bold text-black mb-2 line-clamp-2">{{ $recentProject->title }}</h4>
                                <a href="{{ route('projects.show', $recentProject->slug) }}" class="text-black hover:text-acttive text-sm font-medium">
                                    READ MORE »
                                </a>

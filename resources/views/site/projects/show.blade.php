    ...
    <div class="container mx-auto px-6 py-16">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-8">
                <h1 class="text-4xl font-bold text-gray-900 mb-4">Project with Title, Image and Meta Info</h1>
            </div>
            ...
            <div class="text-center mb-6">
                ...
                <p class="text-gray-600 text-sm mb-4">Published in Projects, Portfolio</p>
            ...
            <div class="mt-12 pt-8 border-t border-gray-300">
                <h3 class="text-2xl font-bold text-gray-900 mb-6">Comments ({{ $project->comments->count() }})</h3>
            ...
            <div class="mt-12 pt-8 border-t border-gray-300">
                <div class="flex items-center mb-4">
                    <span class="text-gray-600 font-medium mr-4">Share Project:</span>
            ...
            <div class="mt-12 pt-8 border-t border-gray-300">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    @php
                        $recentProjects = \App\Models\ProjectPost::latest()->take(3)->get();
                    @endphp
                    @foreach($recentProjects as $recentProject)
                        <div class="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                            ...
                            @endif
                            <div class="p-4">
                                <h4 class="font-bold text-gray-900 mb-2 line-clamp-2">{{ $recentProject->title }}</h4>
                                <a href="{{ route('projects.show', $recentProject->slug) }}" class="text-blue-600 hover:text-blue-700 text-sm font-medium">
                                    READ MORE »
                                </a>
                                <p class="text-gray-500 text-sm mt-2">
                                    {{ $recentProject->created_at->format('F d, Y') }} • No Comments
                                </p>
                            </div>
                        </div>
                    @endforeach

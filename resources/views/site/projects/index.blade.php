...
@section('content')
    <div class="bg-background text-text min-h-screen pb-16 px-4">
        <div class="container mx-auto">
            <h1 class="text-5xl font-extrabold text-center text-text mb-16 pt-8">Projects</h1>
                    ...
                    <div class="bg-gradient-to-tl from-[#1e2024] via-white/10 to-[#23272b] rounded-3xl overflow-hidden shadow-lg shadow-accent/30 hover:shadow-acttive/50 transform transition duration-300 group">
                        <a href="{{ route('projects.show', $project->slug) }}" class="">
                            ...
                            <div class="p-6">
                                ...
                                <p class="text-muted mb-4 line-clamp-3">{{ \Illuminate\Support\Str::limit($project->description, 120) }}</p>
                                    ...
                                    <div class="flex space-x-2">
                                        @if ($project->github_link)
                                            <a href="{{ $project->github_link }}" target="_blank"
                                               class="inline-flex items-center px-3 py-2 bg-gray-700 text-background rounded-lg hover:bg-gray-600 transition duration-300 font-medium text-sm">
                                                GitHub

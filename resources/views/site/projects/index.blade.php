                                        ...
                                        <div class="flex space-x-2">
                                            @if ($project->github_link)
                                                <a href="{{ $project->github_link }}" target="_blank"
                                                   class="inline-flex items-center px-3 py-2 bg-gray-700 text-background rounded-lg hover:bg-gray-600 transition-all duration-300 font-medium text-sm group-">
                                                    GitHub

...
@section('content')
<div class="bg-white text-gray-900 min-h-screen"></div>
    <!-- Main Content -->
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mt-12 pt-8 border-t border-gray-300">
                <div class="flex items-center mb-4">
                    <span class="text-gray-600 font-medium mr-4">Share Article:</span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    @foreach($recentPosts as $recentPost)
                        <div class="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                            ...
                            @endif
                            <div class="p-4">
                                <h4 class="font-bold text-gray-900 mb-2 line-clamp-2">{{ $recentPost->title }}</h4>
                                <a href="{{ route('site.blog.show', $recentPost->slug) }}" class="text-blue-600 hover:text-blue-700 text-sm font-medium">
                                    READ MORE »
                                </a>
                                <p class="text-gray-500 text-sm mt-2">
                                    {{ $recentPost->created_at->format('F d, Y') }} • No Comments
                                </p>
                            </div>
                        </div>
                    @endforeach

                        ...
                        <div class=" rounded-3xl p-8 shadow-lg shadow-accent/30 hover:shadow-xl transition-all duration-300">
                            ...
                            <div class="space-y-8">
                                <div class="flex items-start space-x-4 group">
                                    ...
                                    <div>
                                        <h3 class="font-semibold text-text mb-2">Email</h3>
                                        <a href="mailto:{{ $contact->email }}" class="text-accent hover:text-acttive transition-colors duration-300 text-lg">
                                            {{ $contact->email }}
                                        </a>
                                    </div>
                                </div>
                                ...
                                @if($contact->phone)
                                    <div class="flex items-start space-x-4 group">
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-text mb-2">Phone</h3>
                                            <a href="tel:{{ $contact->phone }}" class="text-accent hover:text-acttive transition-colors duration-300 text-lg">
                                                {{ $contact->phone }}
                                            </a>
                                        </div>
                                    </div>
                                ...
                                @if($contact->address)
                                    <div class="flex items-start space-x-4 group">
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-text mb-2">Location</h3>
                            ...
                            @if($contact->social_links)
                                <div class="mt-10 pt-8 border-t border-accent/20">
                                    <h3 class="font-semibold text-text mb-6">Follow Me</h3>

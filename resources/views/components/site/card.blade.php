...
<a href="{{ $href }}"
   class="group block rounded-3xl overflow-hidden  shadow-lg shadow-black/30 hover:shadow-green-500/30 transition-all duration-300 cursor-pointer Card_content_animation reveal-on-scroll">
  <div class="relative overflow-hidden">
    <img src="{{ $image }}" alt="{{ $title }}"
         class="w-full h-64 object-cover transition-transform duration-500 group-hover:scale-125 object-top origin-top">

...
<div class="space-y-6">
    <h3 class="text-2xl font-bold text-text mb-6">Technical Skills</h3>
            ...
            @foreach($skills as $index => $skill)
                <div class="space-y-3">
                    <div class="flex justify-between items-center">
                        <span class="text-text font-medium text-lg">{{ $skill['name'] }}</span>
    ...
    @else
        ...
        <div class="text-center py-8">
            <p class="text-muted text-lg">No skills added yet. Add your skills through the admin panel.</p>
        </div>
    @endif
</div> 